  ...
  leading-relaxed
        ...
        <Markdown
          ...
          components={{
            ...
            h2: ({ children }) => (
              <h2 className='text-xl font-semibold mt-4 mb-2 text-slate-100'>{children}</h2>
            ),
            h3: ({ children }) => (
            ...
            td: ({ children }) => (
              <td className='border border-white/10 px-3 py-2 text-sm'>
                {children}
              </td>
            ),
            a: ({ href, children }) => (
              ...
              return (
                <div className='my-4 overflow-hidden rounded-xl border border-white/10 bg-[#111318]'>
                  <div className='flex items-center justify-between bg-[#1b1d24] border-b border-white/10 px-4 py-2'>
                    ...
                    <button className='flex items-center gap-1 text-xs text-slate-300 hover:text-white cursor-pointer' 
            ...
            img: ({ src }) => {
              ...
              return (
                <img
                  ...
                  loading="lazy"
                  onError={(e) => e.currentTarget.remove()}
                  className="max-w-md w-full rounded-xl object-contain border border-white/10 cursor-zoom-in hover:opacity-95 transition my-3"
                />
              )
            }
          }}
